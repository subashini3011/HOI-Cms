...
const OutletFormPhoneNumber = ({ getFieldDecorator, fieldInfo }) => {
  return (
...
export default OutletFormPhoneNumber;

OutletFormPhoneNumber.propTypes = {
  fieldInfo: PropTypes.arrayOf(PropTypes.any).isRequired,
  getFieldDecorator: PropTypes.func.isRequired
};

OutletFormPhoneNumber.defaultProps = {};
